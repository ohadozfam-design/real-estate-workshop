...
const faqs = [
  {
    q: "אין לי ניסיון קודם בנדל״ן. הוורקשופ מתאימה לי?",
    a: "כן. הוורקשופ בנויה למשקיעים ויזמים גם בלי ניסיון קודם. עובדים על עסקאות אמיתיות שלב אחר שלב, כך שתסיים עם תהליך עבודה ברור ליישום.",
  },
  {
    q: "האנגלית שלי בינונית. אצליח מול הסוכנים?",
    a: "בדיוק בשביל זה יש בוורקשופ תסריטי שיחה ומיילים מוכנים, מילה במילה באנגלית. מעתיקים, מתאימים ושולחים.",
  },
  {
    q: "עדיין אין לי הון להשקעה. שווה לי להשתתף?",
    a: "הוורקשופ מלמדת את השיטה והתהליך: איתור, ניתוח והגשת הצעה. הכלים והמחשבונים נשארים אצלך לתמיד, ומחכים לרגע שתהיה מוכן.",
  },
  {
    q: "מה אם מצאתי עסקה טובה אבל אין לי הון עצמי לקנות אותה?",
    a: "ברגע שעולים על עסקה אמיתית מתחת למחיר השוק, למכור אותה ליזם אחר (Wholesaling) ולגזור עליה רווח מהיר של אלפי דולרים זה החלק הקל ביותר. בוורקשופ נלמד בדיוק איך לזהות את המספרים שגורמים לכל משקיע לקפוץ על ההצעה שלך.",
  },
  {
    q: "מה אם ארגיש שזה לא בשבילי?",
    a: "יש אחריות 100%: אם תרגיש שלא קיבלת לפחות פי 10 מהערך, שלח הודעה עד 24 שעות מסיום הוורקשופ וקבל החזר מלא. כל החומרים נשארים אצלך.",
  },
  {
