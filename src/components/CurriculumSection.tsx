      ...
      <div className="mx-auto max-w-5xl">
            ...
            <Reveal key={day.label}>
              <div>
                ...
                <div className="flex items-baseline gap-3 border-b border-drift/15 pb-4">
                  <h3 className="text-xl font-extrabold tracking-tight text-cloud sm:text-3xl">
                    {day.label}
                  </h3>
                  <span className="text-base font-bold text-gold">· {day.date}</span>
                </div>
                  ...
                  {day.modules.map((m) => (
                    ...
                    >
                      <div className="flex items-baseline gap-3 sm:block">
                        <span className="text-xs font-bold uppercase tracking-[0.22em] text-drift sm:mb-2 sm:block">
                          מודול
                        </span>
                      ...
                      <div>
                        <h4 className="text-xl font-bold tracking-tight text-cloud">{m.title}</h4>
                        <div className="mt-3 border-r-2 border-gold/60 pr-4">
                          <div className="text-xs font-bold uppercase tracking-wider text-gold">
                            התוצאה שתצאו איתה
                          </div>
                          <p className="mt-1.5 text-lg leading-relaxed text-cloud/90">{m.outcome}</p>
                        </div>
                      </div>
                    </li>
                  ))}
        ...
        <Reveal delay={0.08}>
          <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl bg-gold px-8 py-11 text-center text-night sm:px-12">
            ...
            <div>
              <div className="text-sm font-bold uppercase tracking-[0.22em] text-night/70">
                התוצאה הסופית
              </div>
